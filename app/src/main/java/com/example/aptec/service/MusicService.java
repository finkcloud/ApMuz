...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PLAY = "com.example.aptec.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.example.aptec.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "com.example.aptec.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "com.example.aptec.ACTION_NEXT";
    public static final String ACTION_STOP = "com.example.aptec.ACTION_STOP";
    ...
    private ArrayList<Music> audioList;
    private int musicIndex = -1;
    private Music activeMusic; //an object of the currently playing audio
...
// Perform one-time setup procedures
    ...
    public int onStartCommand(Intent intent, int flags, int startId ){
      ...
      /*  try {
        ...
        try {
            ...
            musicIndex = storage.loadAudioIndex();

            if (musicIndex != -1 && musicIndex < audioList.size()) {
                //index is in a valid range
                activeMusic = audioList.get(musicIndex);
            } else {
                stopSelf();
            }
        } catch (NullPointerException e) {
    ...
    private void initMediaPlayer() {
        ...
        try {
            ...
            mediaPlayer.setDataSource(activeMusic.getSong());
        } catch (IOException e) {
            e.printStackTrace();
            stopSelf();
        }
    ...
    private void skipToNext() {
        ...
        if (musicIndex == audioList.size() - 1) {
            //if last in playlist
            musicIndex = 0;
            activeMusic = audioList.get(musicIndex);
        } else {
        ...
        //Update stored index
        new StorageUtil(getApplicationContext()).storeAudioIndex(musicIndex);
